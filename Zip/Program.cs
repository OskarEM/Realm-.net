    ...
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                var Food1 = new Food { Name = "Ape", Calories = 500, Carbohydrates = 20, Fat = 1000, Protein = 10 };
                ...
                var Food2 = new Food { Name = "Cat", Calories = 5000, Carbohydrates = 2010, Fat = 100, Protein = 10 };
